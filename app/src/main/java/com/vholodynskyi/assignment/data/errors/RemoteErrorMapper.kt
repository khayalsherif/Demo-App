package com.vholodynskyi.assignment.data.errors

import com.vholodynskyi.assignment.data.remote.error.ServerProblemDescription
...
class RemoteErrorMapper : ErrorMapper {
    override fun mapError(throwable: Throwable) = when (throwable) {
        ...
        else -> com.vholodynskyi.assignment.domain.exceptions.UnknownError(throwable)
    }
